...
model_name = 'sphere20a'
model_file = 'models/sphere20a.pth'
lfw_folder = Path("data/faces/lfw/")
use_cuda = True

predicts=[]
net = getattr(net_sphere, model_name)()
...
for i in range(6000):
    ...
    img1 = alignment(cv2.imread(str(lfw_folder / name1)),landmark[name1])
    img2 = alignment(cv2.imread(str(lfw_folder / name2)),landmark[name2])
...
for idx, (train, test) in enumerate(folds):
    print("Fold {}/{}".format(idx + 1, len(folds)))
